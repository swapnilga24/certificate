...
<h3>Room Allocated<a href="Allocated2.php">  Click here</a></h3>
</br>
<h3>Waiting List<a href="Waitlist2.php">  Click here</a></h3>
 </br></br>
		<h3>	
		<div>
         <label>Enter your MIS Number:-</label>
	  	 <input type="text" name="misno" align="right" id="h1" placeholder="11111111" required><br>
	    </div>
		</h3>
...
<?php
	...
	$sql1="select fname from register_girls where gname=$res1";
