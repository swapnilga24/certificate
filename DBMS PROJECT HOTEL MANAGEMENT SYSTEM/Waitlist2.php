...
<body style="text-align: center;background-color: lightgreen;">
	...
	<h2 style="text-align: left;background-color: yellow;width: 200px;" >Waiting List  :  </h2>
		<h3 style="float: right;padding-right: 100px;"><a href="status2.php">BACK</a></h3>
...
<?php
	...
	$sql1="select fname,gname,category,cg from register_girls where category='OPEN' or category='OTHERS' ORDER BY cg ASC,pri_cat ASC LIMIT 5;";
